...
<button class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-user-plus"></i> tambah</button>
<button class="btn btn-danger" ng-click="hapus()"><i class="fa fa-user-times"></i> Hapus</button>
</div>
...
<tr ng-repeat="item in users">
 <td> <input type="checkbox"  checklist-model="user.users" checklist-value="item.id" role></td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	   ...
	   <input type="text" class="form-control" ng-model="first_name">
	   </div>
	   <div class = "form-group">
	   <label>Nama Belakang</label>
	   <input type="text" class="form-control" ng-model="last_name">
	   </div>
	   <div class = "form-group">
	   <label>email</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" ng-click="tambah()"><i class="fa fa-send"></i> Simpan</button>
      </div>
    </div>
